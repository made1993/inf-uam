...
/* Estudio de la no linealidad de las S-boxes del AES
	...
	> length(distanciasH)
	[1] 100000
	> hist(distanciasH, right=FALSE, breaks=0:9, freq = FALSE)
	> hist(distanciasH, right=FALSE, breaks=0:9, freq = FALSE)$counts[0]/1000*100
	[1] 0.378
	> summary(distanciasH)
	   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
	  0.000   3.000   4.000   3.991   5.000   8.000 
*/
void nolinealidadAES(int flagC) {
	uint8_t a, b, c;
	...
	for(i = 0; i < NUMBER_OF_TESTS; i++) {
		...
		/*Toma numeros aleatorios de 8 bits como entrada a las cajas*/
		a = rand();
		b = rand();
		c = a ^ b;
		...
		/*Compara f(a xor b) con f(a) xor f(b)*/
