...
abstract public class Clasificador {
	...
	public static void main(String []args) {
		...
		Datos d1 = Datos.cargaDeFichero("tic-tac-toe.data");
		...
		Clasificador c1 = new ClasificadorGenetico(parada, selecc, fit, inip, mut,
				reco, sepad, tamPoblacion, generaciones,"fits/"+"a");
		validar(part, d1, c1, matriz);
		
		c1 = new ClasificadorGenetico(parada, selecc, fit, inip, mut,
				reco, sepad, tamPoblacion, generaciones, "fits/"+"b");
		validar(part, d1, c1, matriz);
		
		c1 = new ClasificadorGenetico(parada, selecc, fit, inip, mut,
				reco, sepad, tamPoblacion, generaciones, "fits/"+"c");
		validar(part, d1, c1, matriz);
		

		tamPoblacion=100;
		inip= new IniPoblacionTicTac(nreglas, tamPoblacion);
		c1 = new ClasificadorGenetico(parada, selecc, fit, inip, mut,
				reco, sepad, tamPoblacion, generaciones, "fits/"+"a");
		validar(part, d1, c1, matriz);
