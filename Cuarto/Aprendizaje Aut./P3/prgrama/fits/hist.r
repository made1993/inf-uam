...
x1 <- read.table("afits10_100.data")
x2 <- read.table("bfits10_100.data")
x3 <- read.table("cfits10_100.data")
y1 <- read.table("afits100_100.data")
y2 <- read.table("bfits100_100.data")
y3 <- read.table("cfits100_100.data")
z1 <- read.table("afits500_100.data")
z2 <- read.table("bfits500_100.data")
z3 <- read.table("cfits500_100.data")
