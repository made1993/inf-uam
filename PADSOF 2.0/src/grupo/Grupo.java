...
public class Grupo implements Serializable {
	 ...
	 * @param privado si es provado o no
	 ...
	 * Anade un subgrupo
	 * 
	 * @param subgrupo subggruop a anadir
	 ...
	 * 
	 * @param usuario usuario que anade al grupo
	 ...
	 * 
	 * @param men mensaje que anade al grupo
	...
	/**
	 * Anade un mensaje moderado
	 * @param men añade un mensaje moderado 
	 ...
	 * @param barra barra de la app
	 * @param nmAplicacion nombre de la aplicacion
	 * @param nmGrupo nombre del grupo
	 * @param nmDatos nombre del archivo de datos
	 ...
	 * 
	 * @param usuario usuario que contiene el grupo
	 ...
	 * @return la lisat de grupos buscados
	 */
	...
	/**
	 * 
	 * @param mensaje mensaje que se notificara
	 */
	 ...
	 * @param id id de un mensaje que se quiere buscar
	 * @return el mensaje con id
	 */
