...
public class Grupo implements Serializable {
	...
	public boolean addMensaje(MensajeGrupo men) {
		if (moderador == null)
			...
			return men.getRemitente().addMensajeBuzon(
					new MensajeUsuario(men.getIdMensaje(), moderador, men
	...
	public void notificarUsuarios(String mensaje){
		for(Usuario u: listaUsuarios){
			u.addMensajeBuzon(new MensajeUsuario(0, u, mensaje, this.nombre, u));
		}
	}
	@Override
