...
(defun mi-f-ev (estado) 
  (if (juego-terminado-p estado)
    ...
    (- (+(get-pts (estado-lado-sgte-jugador estado))
          ...
          (* 1(f-ev-hu (posiciones-con-fichas-lado (estado-tablero estado) (estado-lado-sgte-jugador estado) 0) estado) )
          )
     (+(get-pts (lado-contrario (estado-lado-sgte-jugador estado))) 
        ...
        (* 1 (f-ev-hu (posiciones-con-fichas-lado (estado-tablero estado) (lado-contrario(estado-lado-sgte-jugador estado)) 0) estado))))))
