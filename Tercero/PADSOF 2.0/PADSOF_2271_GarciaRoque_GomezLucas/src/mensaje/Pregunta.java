 ...
 * @param cuerpo cuerpo de la pregunta
 * @param remitente el que envia la pregunta
 */
	public Pregunta(String cuerpo, Profesor remitente) {
	 ...
	 * @param pos posicion de la respuesta
	...
	/**
	 * 
	 * @param estudiante estudiante de una respuesta
	 ...
	 * @param remitente el profesor que la envia
	 */
	public void addRespuesta(String cuerpo, Estudiante remitente){
		Respuesta rsp= new Respuesta(cuerpo, remitente);
