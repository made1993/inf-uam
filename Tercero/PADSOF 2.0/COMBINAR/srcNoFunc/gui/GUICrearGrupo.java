...
public class GUICrearGrupo extends GUIMenu {
	...
	public void setValores(){
		getM().cargarGrupos();
		System.out.println("tamano lista: "+getM().getListaTodosGrupos().size()+" y "+getM().getListaGrupos().size());
		System.out.println("antes:"+comboListaGrupo.getComponentCount());
		comboListaGrupo.removeAllItems();
		System.out.println("despues:"+comboListaGrupo.getComponentCount());
