...
public class Celda implements Cloneable{
	...
	/**
	 * Añade una ficha a la celda, si no está ocupada
	 * @param f : Ficha a añadir
	 * @return true si se ha podido añadir la ficha
	 */
	...
	/**
	 * Devuelve el color de la ficha de la celda, o null si está vacía
	 * @return el color de la ficha de la celda, o null si está vacía
	 */
