Llamada por el botón de \char`\"{}\-Desconexión\char`\"{}.\hypertarget{getTamanoFichero_SYNOPSIS}{}\section{S\-Y\-N\-O\-P\-S\-I\-S}\label{getTamanoFichero_SYNOPSIS}
...
Es la función llamada cada vez que se pulsa el botón de \char`\"{}\-Desconexión\char`\"{} en el interfaz gráfico.
...
{\bfseries connect\-\_\-client(3)}.\hypertarget{getTamanoFichero_authors}{}\section{A\-U\-T\-O\-R}\label{getTamanoFichero_authors}
