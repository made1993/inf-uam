...
// explained here http://stackoverflow.com/questions/7044670/how-to-determine-game-end-in-tic-tac-toe/7046415#7046415
...
//    buf.append("\n");
        ...
        if (haswon(color[0])) {
            buf.append("Player 1 wins!<br>");
        }
        if (haswon(color[1])) {
            buf.append("Player 2 wins!<br>");
        }
        return buf.toString();
    }

    // return whether columns col has room
    public final boolean isplayable(int col) {
        if (col >= 0 && col < WIDTH) {
